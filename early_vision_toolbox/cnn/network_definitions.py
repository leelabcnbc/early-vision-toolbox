...
net_info_dict = {
    'caffenet': ('caffenet_deploy.prototxt',
                 [('conv1', 2),
                  ('pool1', 1),
                  ('norm1', 1),
                  ('conv2', 2),
                  ...
                  ('fc8', 1),
                  ('prob', 1)], None,
                 os.path.join(dir_dict['caffe_models'], 'bvlc_reference_caffenet',
                              'bvlc_reference_caffenet.caffemodel')),
    'alexnet': ('alexnet_deploy.prototxt',
                [('conv1', 2),
                 ('norm1', 1),
                 ('pool1', 1),
                 ('conv2', 2),
                 ...
                 ('fc8', 1),
                 ('prob', 1)], None,
                os.path.join(dir_dict['caffe_models'], 'bvlc_alexnet', 'bvlc_alexnet.caffemodel')),
    'vgg16': ('VGG_ILSVRC_16_layers_deploy.prototxt',
              [('conv1_1', 2),
               ('conv1_2', 2),
               ('pool1', 1),
               ('conv2_1', 2),
               ...
               ('fc8', 1),
               ('prob', 1)], 'layers {',
              os.path.join(dir_dict['caffe_models'], '211839e770f7b538e2d8', 'VGG_ILSVRC_16_layers.caffemodel')),
    'vgg19': ('VGG_ILSVRC_19_layers_deploy.prototxt',
              [('conv1_1', 2),
               ('conv1_2', 2),
               ('pool1', 1),
               ('conv2_1', 2),
               ...
               ('fc8', 1),
               ('prob', 1)], 'layers {',
              os.path.join(dir_dict['caffe_models'], '3785162f95cd2d5fee77', 'VGG_ILSVRC_19_layers.caffemodel')),
}

# use deepcopy to make sure the correct reference is used.
caffe_deploy_proto_predefined = {key: caffe_deploy_proto_by_layers(get_prototxt(model_file_name), OrderedDict(eat_dict),
                                                                   sep=sep) for
                                 key, (model_file_name, eat_dict, sep, _)
                                 in net_info_dict.items()}
